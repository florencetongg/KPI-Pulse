...
const { createKpi, getKpis, getKpiById, updateKpi, submitProgress, reviewKpi, getKpiHistory, getManagerHistoryFeed, deleteKpi } = require('../controllers/kpiController');
...
router.route('/:id').get(protect, getKpiById).put(protect, authorizeManager, updateKpi).delete(protect, authorizeManager, deleteKpi);
